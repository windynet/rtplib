...
public abstract class AbstractSource extends BaseComponent implements MediaSource {
  ...
  //duration of media stream in nanoseconds
     ...
     * (Non Java-doc.)
     * 
     * @see media.core.component.AbstractSource#setInitialDelay(long) 
     */
     ...
     * (Non Java-doc).
     *
     * @see media.core.spi.MediaSource#connect(media.MediaSink)
     * @param sink
     */
     ...
     * (Non Java-doc).
     *
     * @see media.core.spi.MediaSource#disconnect(org.mobicents.media.server.spi.io.Pipe)
     */
     ...
     * (Non Java-doc).
     * 
     * @see media.core.spi.MediaSource#getPacketsReceived()
     */
     ...
     * (Non Java-doc).
     * 
     * @see media.core.spi.MediaSource#getBytesTransmitted()
     */
    ...
    private class Worker extends Task {
         ...
         * (Non Java-doc.)
         *
         * @see media.core.scheduler.Task#perform()
         */
        public long perform() {
