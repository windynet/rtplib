...
import media.core.component.audio.AudioOutput;
import media.core.component.audio.GoertzelFilter;
import media.core.component.oob.OOBOutput;
import media.core.scheduler.PriorityQueueScheduler;
import media.core.scheduler.Task;
import media.core.spi.ComponentType;
import media.core.spi.format.Format;
import media.core.spi.format.FormatFactory;
import media.core.spi.format.Formats;
import media.core.spi.listener.Listeners;
...
public class DetectorImpl extends AbstractSink implements DtmfDetector {
    ...
    @Override
    public void addListener(media.core.spi.dtmf.DtmfDetectorListener listener) throws TooManyListenersException {

    }

    @Override
    public void removeListener(media.core.spi.dtmf.DtmfDetectorListener listener) {
