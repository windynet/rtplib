...
public class XorMappedAddressAttribute extends AddressAttribute {
	...
	/**
	 * Returns the result of applying XOR on this attribute's address, using the
	 * specified XOR mask. The method may be used for both encoding and decoding
	 * <tt>XorMappedAddresses</tt>.
	 * 
	 * @param xorMask
	 *            the XOR mask to use when obtaining the original address.
	 * 
	 * @return the XOR-ed address.
	 */
