...
package media.core.stun.messages.attributes;

import media.core.network.deprecated.TransportAddress;
import media.core.stun.StunException;
import media.core.stun.messages.attributes.address.*;
import media.core.stun.messages.attributes.control.ControlledAttribute;
import media.core.stun.messages.attributes.control.ControllingAttribute;
import media.core.stun.messages.attributes.data.DataAttribute;
import media.core.stun.messages.attributes.general.*;
...
public class StunAttributeFactory {
	 ...
	 */
	public static StunAttribute createSoftwareAttribute(byte[] software) {
